namespace Mapbox.Unity.Location
{
	...
	public class TransformLocationProvider : AbstractEditorLocationProvider
	{
		...
		protected override void SetLocation()
		{
			...
			currentLocation.UserHeading = _targetTransform.eulerAngles.y;
			currentLocation.LatitudeLongitude = _targetTransform.GetGeoPosition(_map.CenterMercator, _map.WorldRelativeScale);
